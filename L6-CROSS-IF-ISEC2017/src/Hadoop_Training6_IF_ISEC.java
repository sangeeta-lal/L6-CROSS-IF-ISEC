...
public class Hadoop_Training6_IF_ISEC
{
	...
	String logged_file_path = "F:\\Research\\L6-CROSS-IF-ISEC2017\\result\\hd_log_if.txt";
	...
	String table ="hd_if_training6_isec";
    String listing_file_path = "E:\\Sangeeta\\Research\\L6-CROSS-IF-ISEC2017\\result\\hd_java_files.txt"; 
    
    String non_logged_file_path = "E:\\Sangeeta\\Research\\L6-CROSS-IF-ISEC2017\\result\\hd_non_log_if.txt";
	String logged_file_path = "E:\\Sangeeta\\Research\\L6-CROSS-IF-ISEC2017\\result\\hd_log_if.txt";
   ...
   //*/
	...
	{				    
		Hadoop_Training6_IF_ISEC demo = new Hadoop_Training6_IF_ISEC();
...
public void ast_prser(String file_name)
	{
		try
		{
			...
			rawContent = Hadoop_Training6_IF_ISEC.readFileToString(file_name);
