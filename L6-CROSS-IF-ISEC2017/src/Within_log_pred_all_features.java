...
public void read_train_test_split_file(int i)
{ 
try 
	{
	
//http://stackoverflow.com/questions/14682057/java-weka-how-to-specify-split-percentage
...
// computes following metrics:
  ...
  // System.out.println("model ="+classifier_name +"   Acc = "+ avg_accuracy + "  size="+ pred_10_db.size());
	...
	String insert_str =  " insert into "+ result_table +"  values("+ "'"+ source_project+"','"+ source_project+"','"+ classifier_name+"',"+ trains.numInstances() + ","+ tests.numInstances()+","
...
{	  	
	  ...
	  Within_log_pred_all_features clps =  new Within_log_pred_all_features();
