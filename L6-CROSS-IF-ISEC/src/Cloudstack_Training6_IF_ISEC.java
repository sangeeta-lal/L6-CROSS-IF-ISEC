...
public class Cloudstack_Training6_IF_ISEC
{
	...
	String table ="cloudstack_if_training6_isec";	
    String listing_file_path = "F:\\Research\\L6-CROSS-IF-ISEC2017\\result\\cloudstack-4.3.0_java_files.txt";
    
    String non_logged_file_path = "F:\\Research\\L6-CROSS-IF-ISEC2017\\result\\cloudstack_non_log_if.txt";
	String logged_file_path = "F:\\Research\\L6-CROSS-IF-ISEC2017\\result\\cloudstack_log_if.txt";
    ...
    String non_logged_file_path = "E:\\Sangeeta\\Research\\L6-CROSS-IF-ISEC2017\\result\\cloudstack_non_log_if.txt";
	String logged_file_path = "E:\\Sangeeta\\Research\\L6-CROSS-IF-ISEC2017\\result\\cloudstack_log_if.txt";
   ...
   //*/
	...
	{				    
		Cloudstack_Training6_IF_ISEC demo = new Cloudstack_Training6_IF_ISEC();
...
public void ast_prser(String file_name)
	{
		try
		{
			...
			rawContent = Cloudstack_Training6_IF_ISEC.readFileToString(file_name);
